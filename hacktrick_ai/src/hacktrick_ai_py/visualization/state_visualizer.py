import pygame
import os, copy, math
from hacktrick_ai.src.hacktrick_ai_py.utils import generate_temporary_file_path, classproperty, cumulative_rewards_from_rew_list
from hacktrick_ai.src.hacktrick_ai_py.static import GRAPHICS_DIR, FONTS_DIR
from hacktrick_ai.src.hacktrick_ai_py.mdp.layout_generator import EMPTY, COUNTER, PROJECTOR_DISPENSER, LAPTOP_DISPENSER, SOLAR_CELL_DISPENSER, CONSTRUCTION_SITE, CONTAINER_DISPENSER, SERVING_LOC
from hacktrick_ai.src.hacktrick_ai_py.visualization.visualization_utils import show_image_in_ipython, show_ipython_images_slider
from hacktrick_ai.src.hacktrick_ai_py.visualization.pygame_utils import MultiFramePygameImage, run_static_resizeable_window, vstack_surfaces, scale_surface_by_factor, blit_on_new_surface_of_size
from hacktrick_ai.src.hacktrick_ai_py.mdp.actions import Direction, Action
...
class StateVisualizer:
    ...
    def display_rendered_trajectory(self, trajectories, trajectory_idx=0,  hud_data=None, action_probs=None, img_directory_path=None, img_extension=".png", img_prefix="", ipython_display=True, single=False):
        ...
        if not img_directory_path:
            img_directory_path = generate_temporary_file_path(prefix="hacktrick_visualized_trajectory", extension="")
    ...
    def display_rendered_state(self, state, hud_data=None, action_probs=None, grid=None, img_path=None, ipython_display=False, window_display=False, single=False):
        ...
        state (HacktrickState): state to render
        ...
        if img_path is None and ipython_display:
            img_path = generate_temporary_file_path(prefix="hacktrick_visualized_state_", extension=".png")
