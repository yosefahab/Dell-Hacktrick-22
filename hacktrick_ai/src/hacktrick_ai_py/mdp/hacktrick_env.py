...
import time
import numpy as np
from hacktrick_ai.src.hacktrick_ai_py.utils import mean_and_std_err, append_dictionaries
from hacktrick_ai.src.hacktrick_ai_py.mdp.actions import Action
from hacktrick_ai.src.hacktrick_ai_py.mdp.hacktrick_mdp import HacktrickGridworld, EVENT_TYPES
from hacktrick_ai.src.hacktrick_ai_py.mdp.hacktrick_trajectory import TIMESTEP_TRAJ_KEYS, EPISODE_TRAJ_KEYS, DEFAULT_TRAJ_KEYS
from hacktrick_ai.src.hacktrick_ai_py.planning.planners import MediumLevelActionManager, MotionPlanner, NO_COUNTERS_PARAMS
...
class HacktrickEnv(object):
    ...
    def __init__(self, mdp_generator_fn, start_state_fn=None, horizon=MAX_HORIZON, mlam_params=NO_COUNTERS_PARAMS, info_level=0, num_mdp=1, initial_info={}):
        ...
        """
        assert callable(mdp_generator_fn),  "HacktrickEnv takes in a HacktrickGridworld generator function. " \
                                            "If trying to instantiate directly from a HacktrickGridworld " \
                                            "instance, use the HacktrickEnv.from_mdp method"
        ...
        if self.horizon >= MAX_HORIZON and self.info_level > 0:
            print("Environment has (near-)infinite horizon and no terminal states. \
                Reduce info level of HacktrickEnv to not see this message.")
    ...
    def get_rollouts(self, agent_pair, num_games, display=False, dir=None, final_state=False, display_phi=False,
        ...
        from hacktrick_ai.src.hacktrick_ai_py.agents.benchmarking import AgentEvaluator
    ...
    def get_discounted_rewards(trajectories, gamma):
        ...
        return HacktrickEnv._get_discounted_rewards_with_horizon(rews, gamma, horizon)
...
class Hacktrick(gym.Env):
    ...
    def reset(self):
        ...
        return {"both_agent_obs": both_agents_ob, 
                "hacktrick_state": self.base_env.state, 
                "other_agent_env_idx": 1 - self.agent_idx}
