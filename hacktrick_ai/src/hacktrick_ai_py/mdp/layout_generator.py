...
import random, copy
from hacktrick_ai.src.hacktrick_ai_py.utils import rnd_int_uniform, rnd_uniform
from hacktrick_ai.src.hacktrick_ai_py.mdp.actions import Action, Direction
from hacktrick_ai.src.hacktrick_ai_py.mdp.hacktrick_mdp import HacktrickGridworld, Recipe
