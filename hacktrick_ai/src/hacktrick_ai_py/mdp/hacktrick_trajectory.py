...
This would require changes both throughout this repo and hacktrick-ai repo, so it's blue sky goal for now


This file's utility functions represents a primitive first-step towards treating trajectories as first class objects


The standard format for Hacktrick trajectories is:
    trajs = {
