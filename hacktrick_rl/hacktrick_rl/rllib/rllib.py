...
from hacktrick_ai.src.hacktrick_ai_py.agents.agent import Agent, AgentPair, StayAgent
...
from hacktrick_rl.hacktrick_rl.rllib.utils import softmax, get_base_ae, get_required_arguments, iterable_equal
